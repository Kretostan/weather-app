		...
		<>
			...
			>
				<div className="flex flex-col gap-10 text-center">
					<h2 className="text-2xl sm:text-3xl h2-shadow">
						Welcome!{" "}
						<span className="hidden sm:visible">in Weather Application</span>
					</h2>
					<p className="px-10 max-w-[350px]">
						Start by typing a city name. We'll help you check the weather and
						plan your day!
					</p>
				</div>
				<div className="flex flex-col gap-10">
					<form
						className="flex flex-col justify-center sm:gap-4"
						onSubmit={async (e) => {
							e.preventDefault();
					...
					>
						<div className="flex flex-col">
							...
							/>
							<p
								className={`px-2 text-sm text-[#FF6F61] ${!fetched ? "invisible" : "visible"}`}
							>
